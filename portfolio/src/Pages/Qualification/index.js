...
export default function Qualifications() {
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper', p: 3}}>
        ...
        <ListItemText
          ...
          secondary={
            <React.Fragment>
              ...
              {" — B.Tech, Electronics and Comunication Engineering"}
            </React.Fragment>
          }
        />
      </ListItem>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Alphores" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyrgO2IQP0aKFYWfRh43BDAr6BiOXliaVXDw&usqp=CAU" />
        </ListItemAvatar>
        <ListItemText
          ...
          secondary={
            <React.Fragment>
              ...
              {" — Intermediate studies with M.P.C"}
            </React.Fragment>
          }
        />
      </ListItem>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="St.mary's
        " src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWyIitJXugGLNtAeimFta_htU_wy1gsPwxyQ&usqp=CAU" />
        </ListItemAvatar>
        <ListItemText
          primary="St.Mary's Global School"
          secondary={
            <React.Fragment>
              <Typography
                sx={{ display: 'inline' }}
